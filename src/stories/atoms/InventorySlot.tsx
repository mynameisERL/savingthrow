...
export const InventorySlot = ({ label, itemInfo }: InventorySlotProps) => {
    return (
        <section
        className="text-xl font-bold text-white-100 uppercase bg-stone-600 rounded-lg shadow-lg font-medieval tracking-widest w-35 h-35 grid text-center"
        >
        {itemInfo ? 
        <section className="relative group grid">
            <img src={`src/assets/items/${itemInfo.imgUrl}`} className="w-30 h-30 m-auto rounded-md"></img>
